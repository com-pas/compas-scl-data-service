...
public interface CompasSclDataRepository {
     ...
     */
    List<IItem> list(String tenant, SclFileType type);
     ...
     */
    List<IHistoryItem> listVersionsByUUID(String tenant, SclFileType type, UUID id);
     ...
     */
    void create(String tenant, SclFileType type, UUID id, String name, String scl, Version version, String who, List<String> labels);
