...
public class GetResponseEncoder extends AbstractEncoder<GetResponse> {
    @Override
    public String encode(GetResponse jaxbObject) {
        return WebsocketSupport.encode(jaxbObject, GetResponse.class);
    }
}
