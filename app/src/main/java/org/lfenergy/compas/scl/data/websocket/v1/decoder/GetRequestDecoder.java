...
public class GetRequestDecoder extends AbstractDecoder<GetRequest> {
    @Override
    ...
    @Override
    public GetRequest decode(String message) {
        return WebsocketSupport.decode(message, GetRequest.class);
    }
}
