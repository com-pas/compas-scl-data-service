...
public class CreateRequestEncoder extends AbstractEncoder<CreateRequest> {
    @Override
    public String encode(CreateRequest jaxbObject) {
        return WebsocketSupport.encode(jaxbObject, CreateRequest.class);
    }
}
