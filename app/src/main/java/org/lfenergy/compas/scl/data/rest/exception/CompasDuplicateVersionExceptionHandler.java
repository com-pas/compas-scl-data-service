...
@Provider
public class CompasDuplicateVersionExceptionHandler implements ExceptionMapper<CompasDuplicateVersionException> {
    @Override
    public Response toResponse(CompasDuplicateVersionException exception) {
