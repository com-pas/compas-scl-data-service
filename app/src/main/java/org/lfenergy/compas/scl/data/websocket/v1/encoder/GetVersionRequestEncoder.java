...
public class GetVersionRequestEncoder extends AbstractEncoder<GetVersionRequest> {
    @Override
    public String encode(GetVersionRequest jaxbObject) {
        return WebsocketSupport.encode(jaxbObject, GetVersionRequest.class);
    }
}
